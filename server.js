...
process.title = '[server] ' + config.server.port;
...
/*
        ...
        response.end(readFileSync("fit.js", "utf8"));
    } else if (url == '/attach.js') {
        response.writeHead(200, {
            "Content-Type": "application/javascript"
        });
        response.end(readFileSync("attach.js", "utf8"));
    } else if (url == '/weblinks.js') {
        response.writeHead(200, {
            "Content-Type": "application/javascript"
        });
        response.end(readFileSync("weblinks.js", "utf8"));
*/
    } else if (url == '/wshell3.tgz') {
        response.writeHead(200, {
            "Content-Type": "application/octet-stream"
        });
        response.end(readFileSync("../wshell3.tgz", "binary"), "binary");
